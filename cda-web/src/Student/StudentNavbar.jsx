        ...
        <>
            <header className="d-flex text-bg-dark flex-wrap justify-content-center py-3  border-bottom">
                ...
                <ul className="nav nav-pills fw-bold">
                    <li className="nav-item"><Link to="/student" className="nav-link text-info">Course</Link></li>
                    <li className="nav-item"><Link to="/student/searchOtherStudent" className="nav-link text-info">Search Students</Link></li>
